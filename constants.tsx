...
export const FOOD_VOCAB: VocabularyItem[] = [
  ...
  { id: 'f2', word: 'Can of Beans', spanish: 'Lata de Judías', category: 'Forest Food', icon: '/beans-nobg.png', color: 'bg-emerald-100' },
  ...
  { id: 'f6', word: 'Almonds', spanish: 'Almendras', category: 'Forest Food', icon: '/almond-nobg.png', color: 'bg-yellow-100' },
